...
import com.newgen.iforms.user.flexiapi.DukcapilRequest;
import com.newgen.iforms.user.flexiapi.DukcapilResponse;
import com.newgen.iforms.user.flexiapi.FlexiRequest;
import com.newgen.iforms.user.flexiapi.FlexiRequestInput;
import com.newgen.iforms.user.flexiapi.FlexiRequestMember;
import com.newgen.iforms.user.flexiapi.FlexiRequestOutput;
import com.newgen.iforms.user.flexiapi.FlexiResponse;
...
"</PersonalDetails>	";
 ...
 public static String encrypt(String strToEncrypt) {
  ...
  public String executeServerEvent(IFormReference ifr, String ctrlName, String eventType, String data) {
	  try{		  
		  String request = parsingApiDukcapil(ifr, ctrlName, eventType, data);
      }
      catch(Exception | Error ex){
          NGLogger.writeConsoleLog(ifr.getCabinetName(), ifr.getProcessName(), ex.getMessage());
      }
	  
	  return "";
  }
  
  public String parsingApiDukcapil(IFormReference ifr, String ctrlName, String eventType, String data) {
...
//          dukRequest.setThreshold((String)"90");
          ...
          NGLogger.writeConsoleLog(ifr.getCabinetName(), ifr.getProcessName(), "Data Entity : " + jsonInputString);
